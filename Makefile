...
DOCKER_REPO=datawireio/pokemon
...
run-docker: docker
	...
	docker run --rm --name datawire-pokemon -e DATAWIRE_ROUTABLE_HOST=127.0.0.1 -e DATAWIRE_TOKEN=$(DATAWIRE_TOKEN) -it -p 5000:5000 $(DOCKER_REPO):$(VERSION)
