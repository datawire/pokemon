...
LABEL PROJECT_REPO_URL = "git@github.com:datawire/pokemon.git" \
      PROJECT_REPO_BROWSER_URL = "https://github.com/datawire/pokemon" \
      DESCRIPTION = "Datawire pokemon" \
      VENDOR = "Datawire" \
      VENDOR_URL = "https://datawire.io/"

WORKDIR /opt/datawire/pokemon
...
COPY config/ ./config
RUN mv /opt/datawire/pokemon/config/nginx.conf /etc/nginx/nginx.conf
